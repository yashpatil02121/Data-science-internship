...
pd.read_csv("Chicago_Crimes_2012_to_2017.csv").groupby([pd.read_csv("Chicago_Crimes_2012_to_2017.csv")['Primary Type']]).size().sort_values(ascending=True).plot(kind='barh')
